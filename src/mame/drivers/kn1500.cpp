...
void kn1500_state::kn1500_mem(address_map &map)
{
	...
	map(0x780000, 0x78ffff).rw(FUNC(kn1500_state::dsp_lcd_r), FUNC(kn1500_state::dsp_lcd_w)); // ~CS0 & A19=1 & A18-16=000: MSAR0=78 MAMR0=3f
...
{
	uint8_t value = m_dsp_lcd_bit7 | m_dsp_lcd_byte;
