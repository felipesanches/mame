...
class macronix_29lv160b_device : public intelfsh16_device
{
public:
	macronix_29lv160b_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock = 0);
};
...
DECLARE_DEVICE_TYPE(MACRONIX_29LV160B,       macronix_29lv160b_device)
