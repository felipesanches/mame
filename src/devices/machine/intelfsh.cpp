...
DEFINE_DEVICE_TYPE(MACRONIX_29LV160B,        macronix_29lv160b_device,        "mx29lv160b",               "Macronix MX29LV160B Flash")
...
macronix_29lv160b_device::macronix_29lv160b_device(const machine_config &mconfig, const char *tag, device_t *owner, uint32_t clock)
	: intelfsh16_device(mconfig, MACRONIX_29LV160B, tag, owner, clock, 0x200000, MFG_MACRONIX, 0x2249) { m_bot_boot_sector = true; }
